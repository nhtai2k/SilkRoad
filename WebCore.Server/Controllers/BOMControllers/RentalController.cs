...
//    {
//        private readonly IRentalHelper _helper;
//        private readonly IStringLocalizer<SharedResource> _localizer;
//        public RentalController(IRentalHelper helper, IStringLocalizer<SharedResource> localizer) { _helper = helper; _localizer = localizer; }
...
//        [HttpPost("Create")]
//        public async Task<IActionResult> Create([FromBody] RentalDTO model)
//        {
...
//        [HttpPut("Update")]
//        public async Task<IActionResult> Update([FromBody] RentalDTO model)
//        {
//            if (model == null || !ModelState.IsValid)
//                return Failed(Common.EStatusCodes.BadRequest, _localizer["invalidData"]);
//            var userName = User.Identity?.Name;
