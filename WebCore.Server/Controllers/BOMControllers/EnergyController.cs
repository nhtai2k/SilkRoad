...
namespace WebCore.Server.Controllers.BOMControllers
{
    ...
    {
        private readonly IEnergyHelper _helper;
        private readonly IStringLocalizer<SharedResource> _localizer;
        public EnergyController(
            IEnergyHelper helper,
        ...
        public async Task<IActionResult> GetAll(int pageIndex, int pageSize)
        {
            ...
            Pagination<EnergyDTO> data = await _helper.GetAllAsync(pageIndex, pageSize);
            return Succeeded<Pagination<EnergyDTO>>(data, _localizer["dataFetchedSuccessfully"]);
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            return Succeeded<EnergyDTO>(data, _localizer["dataFetchedSuccessfully"]);
        }

        [HttpPost("create")]
        public async Task<IActionResult> Create([FromBody] EnergyDTO model)
        {
        ...
        [HttpPut("update")]
        public async Task<IActionResult> Update([FromBody] EnergyDTO model)
        {
            if (model == null || !ModelState.IsValid)
                return Failed(EStatusCodes.BadRequest, _localizer["invalidData"]);
            var userName = User.Identity?.Name;
