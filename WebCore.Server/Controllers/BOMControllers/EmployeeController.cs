...
//    {
//        private readonly IEmployeeHelper _helper;
//        private readonly IStringLocalizer<SharedResource> _localizer;
//        public EmployeeController(IEmployeeHelper helper, IStringLocalizer<SharedResource> localizer) { _helper = helper; _localizer = localizer; }
...
//        public async Task<IActionResult> GetByFilter([FromBody] EmployeeFilterModel model)
//        {
//            if (model.PageIndex < 1 || model.PageSize < 1)
//                return Failed(Common.EStatusCodes.BadRequest, _localizer["invalidPageIndex"]);
//            var data = await _helper.GetAllAsync(model);
//            return Succeeded(data, _localizer["dataFetchedSuccessfully"]);
//        }
...
//        [HttpGet("getByDepartmentIdNRankId/{departmentId}/{rankId}")]
//        public async Task<IActionResult> GetByDepartmentIdNRankId(int departmentId, int rankId)
//        {
//            var data = await _helper.GetByDepartmentIdNRankIdAsync(departmentId, rankId);
//            return Succeeded(data, _localizer["dataFetchedSuccessfully"]);
//        }
