...
namespace WebCore.Server.Controllers.BOMControllers
{
    ...
    {
        private readonly IDepartmentHelper _helper;
        private readonly IStringLocalizer<SharedResource> _localizer;
        public DepartmentController(IDepartmentHelper helper, IStringLocalizer<SharedResource> localizer) { _helper = helper; _localizer = localizer; }
