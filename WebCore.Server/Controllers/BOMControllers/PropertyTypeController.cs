...
namespace WebCore.Server.Controllers.BOMControllers
{
    ...
    {
        private readonly IPropertyTypeHelper _helper;
        private readonly IStringLocalizer<SharedResource> _localizer;
        public PropertyTypeController(IPropertyTypeHelper helper, IStringLocalizer<SharedResource> localizer) { _helper = helper; _localizer = localizer; }
        ...
        [HttpPost("create")]
        public async Task<IActionResult> Create([FromBody] PropertyTypeDTO model)
        {
        ...
        [HttpPut("update")]
        public async Task<IActionResult> Update([FromBody] PropertyTypeDTO model)
        {
            if (model == null || !ModelState.IsValid)
                return Failed(EStatusCodes.BadRequest, _localizer["invalidData"]);
            var userName = User.Identity?.Name;
