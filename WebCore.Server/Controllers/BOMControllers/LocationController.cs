...
//    {
//        private readonly ILocationHelper _helper;
//        private readonly IStringLocalizer<SharedResource> _localizer;
//        public LocationController(ILocationHelper helper, IStringLocalizer<SharedResource> localizer) { _helper = helper; _localizer = localizer; }
...
//        [HttpPost("Create")]
//        public async Task<IActionResult> Create([FromForm] LocationDTO model)
//        {
...
//        }
//        [HttpPut("Update")]
//        public async Task<IActionResult> Update([FromForm] LocationDTO model)
//        {
//            if (model == null || !ModelState.IsValid)
//                return Failed(Common.EStatusCodes.BadRequest, _localizer["invalidData"]);
//            var userName = User.Identity?.Name;
