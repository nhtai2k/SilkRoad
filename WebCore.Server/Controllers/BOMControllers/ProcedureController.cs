...
//    {
//        private readonly IProcedureHelper _helper;
//        private readonly IStringLocalizer<SharedResource> _localizer;
//        public ProcedureController(IProcedureHelper helper, IStringLocalizer<SharedResource> localizer) { _helper = helper; _localizer = localizer; }
...
//        [HttpPost("create")]
//        public async Task<IActionResult> Create([FromBody] ProcedureDTO model)
//        {
...
//        [HttpPut("update")]
//        public async Task<IActionResult> Update([FromBody] ProcedureDTO model)
//        {
//            if (model == null || !ModelState.IsValid)
//                return Failed(Common.EStatusCodes.BadRequest, _localizer["invalidData"]);
//            var userName = User.Identity?.Name;
