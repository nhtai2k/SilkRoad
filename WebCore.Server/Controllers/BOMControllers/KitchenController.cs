...
namespace WebCore.Server.Controllers.BOMControllers
{
    ...
    {
        private readonly IKitchenHelper _helper;
        private readonly ILogger<KitchenController> _logger;
        private readonly IStringLocalizer<SharedResource> _localizer;
        public KitchenController(
            IKitchenHelper helper,
        ...
        public async Task<IActionResult> GetAll(int pageIndex, int pageSize)
        {
            ...
            Pagination<KitchenDTO> data = await _helper.GetAllAsync(pageIndex, pageSize);
            return Succeeded<Pagination<KitchenDTO>>(data, _localizer["dataFetchedSuccessfully"]);
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            return Succeeded<KitchenDTO>(data, _localizer["dataFetchedSuccessfully"]);
        }

        [HttpPost("create")]
        public async Task<IActionResult> Create([FromForm] KitchenDTO model)
        {
        ...
        [HttpPut("update")]
        public async Task<IActionResult> Update([FromForm] KitchenDTO model)
        {
            if (model == null || !ModelState.IsValid)
                return Failed(EStatusCodes.BadRequest, _localizer["invalidData"]);
            var userName = User.Identity?.Name;
