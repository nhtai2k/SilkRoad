...
//    [Authorize]
//    public class MallController : BaseApiController
//    {
//        private readonly IMallHelper _helper;
//        private readonly IStringLocalizer<SharedResource> _localizer;
//        public MallController(IMallHelper helper, IStringLocalizer<SharedResource> localizer) { _helper = helper; _localizer = localizer; }
...
//        [HttpPost("create")]
//        public async Task<IActionResult> Create([FromForm] MallDTO model)
//        {
...
//        [HttpPut("update")]
//        public async Task<IActionResult> Update([FromForm] MallDTO model)
//        {
//            if (model == null || !ModelState.IsValid)
//                return Failed(Common.EStatusCodes.BadRequest, _localizer["invalidData"]);
//            var userName = User.Identity?.Name;
