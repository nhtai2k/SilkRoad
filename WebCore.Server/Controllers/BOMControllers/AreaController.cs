...
//    {
//        private readonly IAreaHelper _helper;
//        private readonly IStringLocalizer<SharedResource> _localizer;
//        public AreaController(IAreaHelper helper, IStringLocalizer<SharedResource> localizer) { _helper = helper; _localizer = localizer; }
...
//        }
//        [HttpPost("Create")]
//        public async Task<IActionResult> Create([FromForm] AreaDTO model)
//        {
...
//        }
//        [HttpPut("Update")]
//        public async Task<IActionResult> Update([FromForm] AreaDTO model)
//        {
//            if (model == null || !ModelState.IsValid)
//                return Failed(Common.EStatusCodes.BadRequest, _localizer["invalidData"]);
//            var userName = User.Identity?.Name;
