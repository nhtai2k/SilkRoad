...
//    {
//        private readonly ITableHelper _helper;
...
//            }
//            Pagination<TableDTO> data = await _helper.GetAllAsync(pageIndex, pageSize);
...
//            return Succeeded<TableDTO>(data, _localizer["dataFetchedSuccessfully"]);
//        }
...
//        [HttpPut("update")]
//        public async Task<IActionResult> Update([FromBody] TableDTO model)
//        {
//            if (model == null || !ModelState.IsValid)
//                return Failed(EStatusCodes.BadRequest, _localizer["invalidData"]);
//            var userName = User.Identity?.Name;
