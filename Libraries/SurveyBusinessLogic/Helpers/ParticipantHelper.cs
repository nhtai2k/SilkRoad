...
namespace SurveyBusinessLogic.Helpers
{
    public class ParticipantHelper : IParticipantHelper
    {
        ...
        //public ParticipantHelper(IUnitOfWork unitOfWork, IMapper mapper, IQuestionGroupLibraryHelper questionGroupHelper, IWebHostEnvironment webHostEnvironment)
        //{
        ...
        //}
        //public async Task<Pagination<ParticipantViewModel>> GetAllAsync(DateTime? startDate, DateTime? endDate, int surveyFormId, int pageIndex, int pageSize)
        //{
        ...
        //    //QuestionGroupViewModel questionGroup = _questionGroupHelper.GetEagerQuestionGroupByID();
