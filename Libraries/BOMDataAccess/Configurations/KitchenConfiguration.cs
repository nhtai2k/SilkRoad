...
{
    public class KitchenConfiguration : IEntityTypeConfiguration<KitchenDTO>
    {
        public void Configure(EntityTypeBuilder<KitchenDTO> builder)
        {
            builder.ToTable("Table_Kitchens");
